namespace Videos.Application.Services.Encoding
{
    ...
    public sealed unsafe class H264VideoStreamEncoder //: IDisposable
    {
        ...
        //    if (ffmpeg.avcodec_open2(_pCodecContext, _pCodec, null) < 0) { throw new Exception("Error decode codec"); }
        ...
        //        if (ffmpeg.avcodec_send_frame(_pCodecContext, &frame) < 0) { throw new Exception("Error decode codec"); }
        ...
        //        if (ffmpeg.avcodec_send_frame(_pCodecContext, null) < 0) { throw new Exception("Error decode codec"); }
